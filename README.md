...
3. Use the token in Swagger docs with the `Authorize` button.
4. Create or browse jobs.
5. Save jobs or apply to jobs.
...
This creates sample jobs across backend, frontend, analytics, AI, DevOps, and BI roles.
